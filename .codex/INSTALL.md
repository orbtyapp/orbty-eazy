# Installing Orbty-eazy for Codex
...
3. **Update ~/.codex/AGENTS.md** to include this orbty-eazy section:
   ...
   <EXTREMELY_IMPORTANT>
   You have orbty-eazy. Orbty-eazy teach you new skills and capabilities. RIGHT NOW run: `~/.codex/orbty-eazy/.codex/orbty-eazy-codex bootstrap` and follow the instructions it returns.
   </EXTREMELY_IMPORTANT>
   ```
