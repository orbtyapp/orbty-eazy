...
# IMPORTANT: Run from orbty-eazy directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"orbty-eazy:subagent-driven-development"' "$SESSION_FILE"; then
