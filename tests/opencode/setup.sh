...
mkdir -p "$HOME/.config/opencode/orbty-eazy"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/orbty-eazy/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/orbty-eazy/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/orbty-eazy/.opencode/plugin"
cp "$REPO_ROOT/.opencode/plugin/orbty-eazy.js" "$HOME/.config/opencode/orbty-eazy/.opencode/plugin/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugin"
ln -sf "$HOME/.config/opencode/orbty-eazy/.opencode/plugin/orbty-eazy.js" \
       "$HOME/.config/opencode/plugin/orbty-eazy.js"
...
echo "Plugin installed to: $HOME/.config/opencode/orbty-eazy/.opencode/plugin/orbty-eazy.js"
echo "Plugin registered at: $HOME/.config/opencode/plugin/orbty-eazy.js"
