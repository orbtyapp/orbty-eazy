...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/orbty-eazy
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/orbty-eazy-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using orbty-eazy:subagent-driven-development. The plan is at: $PLAN_PATH"
